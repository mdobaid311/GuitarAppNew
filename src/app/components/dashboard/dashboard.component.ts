...
export class DashboardComponent implements OnInit {
  ...
  onSelectMonthChange(event: any) {
    ...
    this.chartData.getOrderTotalByDay(this.selectedYear, this.selectedMonth).subscribe({
      next: (resp:any) => {
        let monthData:any = [];
  ...
  onSelectDayChange(event: any) {
    ...
    this.chartData.getOrderTotalByHour(this.selectedYear, this.selectedMonth, this.selectedDay).subscribe({
      next: (resp:any) => {
        let hourData:any = [];
