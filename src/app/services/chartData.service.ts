...
export class ChartService {
  ...
  public getFullSalesData(startDate: any, endDate: any, intervaltime: any) {
    const url = `http://3.111.38.149:3000/v2/alsd/get-full-sales-data?start_date=${startDate}&end_date=${endDate}&intervaltime=${intervaltime}`;
    return this.httpClient.get<any[]>(url);
  }
  public getFullSalesDataByRange(startDate: any, endDate: any, intervaltime: any) {
    const url = `http://3.111.38.149:3000/v2/tables/getFullSalesData?start_date=${startDate}&end_date=${endDate}&intervaltime=${intervaltime}`;
    return this.httpClient.get<any[]>(url);
  }

  public getTableData(tableName: any) {
    const url = `http://3.111.38.149:3000/v2/tables?table=${tableName}`;
    return this.httpClient.get<any[]>(url);
  }
}
